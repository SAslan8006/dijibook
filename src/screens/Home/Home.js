      ...
      <View style={styles.category}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <TouchableWithoutFeedback onPress={handleSelectedAll}>
            <Text style={[styles.categoryItem, {color: activeAll ? colors.orange : 'black', borderColor: activeAll ? colors.orange : 'black', backgroundColor: activeAll ? colors.white : 'white' } ]}>All</Text>
          </TouchableWithoutFeedback>
          <TouchableWithoutFeedback onPress={handleSelectedRoman}>
            <Text style={[styles.categoryItem, {color: activeRoman ? colors.orange : 'black', borderColor: activeRoman ? colors.orange : 'black', backgroundColor: activeRoman ? colors.white : 'white' } ]}>Roman</Text>
          </TouchableWithoutFeedback>
          <TouchableWithoutFeedback onPress={handleSelectedSiir}>
            <Text style={[styles.categoryItem, {color: activeSiir ? colors.orange : 'black', borderColor: activeSiir ? colors.orange : 'black', backgroundColor: activeSiir ? colors.white : 'white' } ]}>Siir</Text>
          </TouchableWithoutFeedback>
          <TouchableWithoutFeedback onPress={handleSelectedDeneme}>
            <Text style={[styles.categoryItem, {color: activeDeneme ? colors.orange : 'black', borderColor: activeDeneme ? colors.orange : 'black', backgroundColor: activeDeneme ? colors.white : 'white' } ]}>Deneme</Text>
          </TouchableWithoutFeedback>
          <TouchableWithoutFeedback onPress={handleSelectedBiyografi}>
            <Text style={[styles.categoryItem, {color: activeBiyografi ? colors.orange : 'black', borderColor: activeBiyografi ? colors.orange : 'black', backgroundColor: activeBiyografi ? colors.white : 'white' } ]}>Biyografi</Text>
          </TouchableWithoutFeedback>
          <TouchableWithoutFeedback onPress={handleSelectedEdebiyatInceleme}>
            <Text style={[styles.categoryItem, {color: activeEdebiyat ? colors.orange : 'black', borderColor: activeEdebiyat ? colors.orange : 'black', backgroundColor: activeEdebiyat ? colors.white : 'white' } ]}>Edebiyat Inceleme</Text>
          </TouchableWithoutFeedback>
        </ScrollView>
      </View>
